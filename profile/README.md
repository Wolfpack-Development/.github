...
<div>
  <h2> Was ist <b>Wolfpack</b>?</h2>
  <p><b>Wolfpack</b> ist ein Discord Server, der sich auf Dienstleistungen, wie einen Bot-Coding oder Design-Service, spezialisiert hat.
  Der Begriff "<b>Wolfpack</b>" kommt aus dem Englischen, beudeutet soviel wie Wolfsrudel und spielt auf den Zusammenhalt unserer Community an.</p>
</div>
...
<div>
  <h2>Services</h2>
  <p>Wolfpack bietet unseren Mitgliedern persönliche Bestellservices,
             diese umfassen Designs, Minecraft Plugins und
             personalisierte Discord Bots.</p>
</div>
...
a, img, svg, span, input, button, strong, ion-icon {
	display: block;
}
img {
	height: auto;
...
@media (min-width: 575px) {
   ...
   */
	.service-list, .about-list, .stats-list, .footer-top .container {
...
@media (min-width: 1200px) {
   ...
   */
     ...
     */
		...
		@import url('https://fonts.cdnfonts.com/css/golden-dream');
		...
		.hero {
			...
			background-image: linear-gradient(0deg, rgba(28, 28, 28, 1) 0%, rgba(255, 255, 255, 0) 100%), url(W.png);
			min-height: 80vh;
			background-size: cover;
			background-position: center top;
			box-sizing: border-box;
		...
		.hover-button:hover {
			box-shadow: inset 0px 0px 10px black, 0px 0px 15px rgb(214, 211, 211);
		}
		/* Hier endet der Code für den Button */
		.angebotsbereich {
			padding: 0% 5%;
		}
		/* Das ist der Code für alle Icons*/
		.icon-zeile {
			display: flex;
			justify-content: center;
		}
		...
		/* Der ist der kreis-Code für die Icons */
		.kreiszeile {
			display: flex;
			margin: 40px 0;
			justify-content: space-between;
		...
		.zurück:hover {
			text-decoration: underline rgb(255, 254, 254);
		}
		a {
			text-decoration: none;
			color: white;
